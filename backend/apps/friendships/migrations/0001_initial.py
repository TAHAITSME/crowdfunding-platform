# Generated by Django 4.2.11 on 2026-04-28 22:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='friendship',
            constraint=models.CheckConstraint(check=models.Q(('requester', models.F('addressee')), _negated=True), name='prevent_self_friendship'),
        ),
    ]
